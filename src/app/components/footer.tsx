    ...
    <footer className="mx-0 my-4 w-full px-4 text-sm sm:mx-auto sm:my-12 sm:max-w-3xl sm:px-6">
      <div className="flex flex-col items-center justify-between gap-4 border-t border-gray-300 py-6 sm:flex-row">
        ...
        <nav className="flex gap-4 text-gray-600">
          <a href="/about" className="hover:text-black transition-colors text-gray-900 dark:text-gray-100">About</a>

          <a href="/contact" className="hover:text-black transition-colors text-gray-900 dark:text-gray-100">Contact</a>
        </nav>
